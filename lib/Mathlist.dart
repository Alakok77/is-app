...
List<Widget> Logiclist = [
  Suittap("", Image.asset("images/lo1.png"), Pagepicture(Image.network("https://www.tewfree.com/wp-content/uploads/2011/07/%E0%B8%95%E0%B8%B2%E0%B8%A3%E0%B8%B2%E0%B8%87%E0%B8%84%E0%B9%88%E0%B8%B2%E0%B8%84%E0%B8%A7%E0%B8%B2%E0%B8%A1%E0%B8%88%E0%B8%A3%E0%B8%B4%E0%B8%87.gif"))),
...
List<Widget> Realnumlist = [
  Suittap("", Image.asset("images/real1.png"), Pagepicture(Image.asset("images/real2.png"))),
  Suittap("", Image.asset("images/real3.png"), Pagepicture(Image.asset("images/real4.png"))),
  Suittap("", Image.asset("images/real5.png"), Pagepicture(Image.asset("images/real6.png"))),
  Suittap("", Image.asset("images/real7.png"), Pagepicture(Image.asset("images/real8.png"))),
  Suittap("", Image.asset("images/real9.png"), Pagepicture(Image.asset("images/real10.png"))),
  Suittap("", Image.asset("images/real11.png"), Pagepicture(Image.asset("images/real12.png"))),
  Suittap("", Image.asset("images/real13.png"), Pagepicture(Image.asset("images/real14.png"))),
  Suittap("", Image.asset("images/real15.png"), Pagepicture(Image.asset("images/real16.png"))),
  Suittap("", Image.asset("images/real17.png"), Pagepicture(Image.asset("images/real18.png"))),
  Suittap("", Image.asset("images/real19.png"), Pagepicture(Image.asset("images/real20.png"))),
  Suittap("", Image.asset("images/real21.png"), Pagepicture(Image.asset("images/real22.png"))),
];
...
List<Widget> ExpoLogalist = [
  ...
  Suittap("", Image.asset("images/ex11.png"), Pagepicture(Image.asset("images/ex12.png"))),
  Suittap("", Image.asset("images/ex13.png"), Pagepicture(Image.asset("images/ex14.png"))),
  Suittap("", Image.asset("images/ex15.png"), Pagepicture(Image.asset("images/ex16.png"))),
  Lesson("ฟังก์ชันลอการิทึม"),
  Suittap("", Image.asset("images/ex17.png"), Pagepicture(Image.asset("images/ex18.png"))),
  ...
  Suittap("", Image.asset("images/ex29.png"), Pagepicture(Image.asset("images/ex30.png"))),
  Suittap("", Image.asset("images/ex31.png"), Pagepicture(Image.asset("images/ex32.png"))),

];

List<Widget> Geometrylist = [
  Suittap("", Image.asset("images/ge1.png"), Pagepicture(Image.asset("images/ge2.png"))),
  Suittap("", Image.asset("images/ge3.png"), Pagepicture(Image.asset("images/ge4.png"))),
  Suittap("", Image.asset("images/ge5.png"), Pagepicture(Image.asset("images/ge6.png"))),
  Suittap("", Image.asset("images/ge7.png"), Pagepicture(Image.asset("images/ge8.png"))),
  Suittap("", Image.asset("images/ge9.png"), Pagepicture(Image.asset("images/ge10.png"))),
  Suittap("", Image.asset("images/ge11.png"), Pagepicture(Image.asset("images/ge12.png"))),
  Suittap("", Image.asset("images/ge13.png"), Pagepicture(Image.asset("images/ge14.png"))),
  Suittap("", Image.asset("images/ge15.png"), Pagepicture(Image.asset("images/ge16.png"))),
  Suittap("", Image.asset("images/ge17.png"), PagepicSp(Image.asset("images/ge18.png"),Image.asset("images/ge19.png"),Image.asset("images/ge20.png"))),
  Suittap("", Image.asset("images/ge21.png"), Pagepicture(Image.asset("images/ge22.png"))),
  Suittap("", Image.asset("images/ge23.png"), PagepicSp(Image.asset("images/ge24.png"),Image.asset("images/ge25.png"),Image.asset("images/ge26.png"))),
  Suittap("", Image.asset("images/ge27.png"), Pagepicture(Image.asset("images/ge28.png"))),
];

List<Widget> Countlist = [
  Suittap1("หลักการบวก", Image.asset("images/c5.png")),
  Suittap1("หลักการคูณ", Image.asset("images/c6.png")),
  Suittap1("การเรียงสับเปลี่ยนสิ่งของ\nที่แตกต่างกันทั้งหมด", Image.asset("images/c1.png")),
  Suittap1("การเรียงสับเปลี่ยนสิ่งของ\nที่ไม่แตกต่างกันทั้งหมด", Image.asset("images/c2.png")),
  Suittap1("การเรียงสับเปลี่ยนสิ่งของ\nที่แตกต่างกันทั้งหมดเชิงวงกลม", Image.asset("images/c3.png")),
...
List<Widget> Trigonlist = [
  Suittap("", Image.asset("images/t1.png"), Pagepicture(Image.asset("images/t2.png"))),
  Suittap("", Image.asset("images/t3.png"), PagepicSp(Image.asset("images/t4.png"),Image.asset("images/t5.png"),Image.asset("images/t6.png"),)),
  Suittap("", Image.asset("images/t7.png"), Pagepicture(Image.asset("images/t8.png"))),
  Suittap("", Image.asset("images/t9.png"), Pagepicture(Image.asset("images/t10.png"))),
  Suittap("", Image.asset("images/t11.png"), Pagepicture(Image.asset("images/t12.png"))),
  Suittap("", Image.asset("images/t13.png"), Pagepicture(Image.asset("images/t14.png"))),
  Suittap("", Image.asset("images/t15.png"), Pagepicture(Image.asset("images/t16.png"))),
  Suittap("", Image.asset("images/t17.png"), Pagepicture(Image.asset("images/t18.png"))),
  Suittap("", Image.asset("images/t19.png"), Pagepicture(Image.asset("images/t20.png"))),
];

List<Widget> Complexlist = [
  Suittap("", Image.asset("images/cm1.png"), Pagepicture(Image.asset("images/cm2.png"))),
  Suittap("", Image.asset("images/cm3.png"), Pagepicture(Image.asset("images/cm4.png"))),
  Suittap("", Image.asset("images/cm5.png"), Pagepicture(Image.asset("images/cm6.png"))),
  Suittap("", Image.asset("images/cm7.png"), Pagepicture(Image.asset("images/cm8.png"))),
  Suittap("", Image.asset("images/cm9.png"), Pagepicture(Image.asset("images/cm10.png"))),
  Suittap("", Image.asset("images/cm11.png"), Pagepicture(Image.asset("images/cm12.png"))),
  Suittap("", Image.asset("images/cm13.png"), Pagepicture(Image.asset("images/cm14.png"))),
  Suittap("", Image.asset("images/cm15.png"), Pagepicture(Image.asset("images/cm16.png"))),
  Suittap("", Image.asset("images/cm17.png"), Pagepicture(Image.asset("images/cm18.png"))),
];
...
List<Widget> Sequenlist = [
  Suittap("ลำดับเลขคณิต", Image.asset("images/se1.png"), PageV3v41(Image.asset("images/se1.png"),"a1","n", "d",Image.asset("images/seX.png"))),
  Suittap("ลำดับเรขาคณิต", Image.asset("images/se2.png"), PageV3v42(Image.asset("images/se2.png"), "a1", "r", "n", Image.asset("images/seX.png"))),
  Suittap("อนุกรมเลขตณิต", Image.asset("images/se3.png"), PageV3v43(Image.asset("images/se3.png"), "n","a1", "d", Image.asset("images/seX.png"))),
